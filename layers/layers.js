...
var format_LIM_Z4_4 = new ol.format.GeoJSON();
var features_LIM_Z4_4 = format_LIM_Z4_4.readFeatures(json_LIM_Z4_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LIM_Z4_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LIM_Z4_4.addFeatures(features_LIM_Z4_4);
var lyr_LIM_Z4_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LIM_Z4_4, 
                style: style_LIM_Z4_4,
                popuplayertitle: 'LIM_Z4',
                interactive: true,
                title: '<img src="styles/legend/LIM_Z4_4.png" /> LIM_Z4'
            });
var format_TZ4_5 = new ol.format.GeoJSON();
var features_TZ4_5 = format_TZ4_5.readFeatures(json_TZ4_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TZ4_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TZ4_5.addFeatures(features_TZ4_5);
var lyr_TZ4_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TZ4_5, 
                style: style_TZ4_5,
                popuplayertitle: 'TZ4',
                interactive: true,
    title: 'TZ4<br />\
    <img src="styles/legend/TZ4_5_0.png" /> DIARIO<br />\
    <img src="styles/legend/TZ4_5_1.png" /> LUNES Y MARTES<br />\
    <img src="styles/legend/TZ4_5_2.png" /> MARTES A JUEVES<br />\
    <img src="styles/legend/TZ4_5_3.png" /> MARTES A VIERNES<br />\
    <img src="styles/legend/TZ4_5_4.png" /> MARTES Y JUEVES<br />\
    <img src="styles/legend/TZ4_5_5.png" /> MIXTO<br />\
    <img src="styles/legend/TZ4_5_6.png" /> PROBLEMAS DE SUMINISTRO<br />\
    <img src="styles/legend/TZ4_5_7.png" /> SÁBADO Y DOMINGO<br />\
    <img src="styles/legend/TZ4_5_8.png" /> DOMINGO Y LUNES<br />\
    <img src="styles/legend/TZ4_5_9.png" /> MARTES A SÁBADO<br />' });
var group_ECATEPEC = new ol.layer.Group({
                                layers: [lyr_Positron_0,lyr_CDMX_LIMITE_1,lyr_EDOMEX_LIMITE_2,lyr_ECATEPEC_LIMITE_3,lyr_LIM_Z4_4,lyr_TZ4_5,],
                                fold: 'open',
                                title: 'ECATEPEC'});

lyr_Positron_0.setVisible(true);lyr_CDMX_LIMITE_1.setVisible(true);lyr_EDOMEX_LIMITE_2.setVisible(true);lyr_ECATEPEC_LIMITE_3.setVisible(true);lyr_LIM_Z4_4.setVisible(true);lyr_TZ4_5.setVisible(true);
...
lyr_LIM_Z4_4.set('fieldAliases', {'id': 'id', 'NOMBRE': 'NOMBRE', });
lyr_TZ4_5.set('fieldAliases', {'id': 'id', 'NOMBRE': 'NOMBRE', 'TANDEO': 'TANDEO', 'NO. DIAS': 'NO. DIAS', 'ABAST.': 'ABAST.', });
...
lyr_LIM_Z4_4.set('fieldImages', {'id': '', 'NOMBRE': '', });
lyr_TZ4_5.set('fieldImages', {'id': 'TextEdit', 'NOMBRE': 'TextEdit', 'TANDEO': 'TextEdit', 'NO. DIAS': 'TextEdit', 'ABAST.': 'TextEdit', });
...
lyr_LIM_Z4_4.set('fieldLabels', {'id': 'hidden field', 'NOMBRE': 'inline label - always visible', });
lyr_TZ4_5.set('fieldLabels', {'id': 'hidden field', 'NOMBRE': 'hidden field', 'TANDEO': 'inline label - always visible', 'NO. DIAS': 'hidden field', 'ABAST.': 'hidden field', });
lyr_TZ4_5.on('precompose', function(evt) {
